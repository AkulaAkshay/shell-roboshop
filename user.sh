...
SCRIPT_DIR=$PWD
LOG_FILE="$LOGS_FOLDER/$SCRIPT_NAME.log" #full path - /var/log/shell-script/user.log
...
cp $SCRIPT_DIR/user.service /etc/systemd/system/user.service &>>$LOG_FILE # its better to give full path while copying 
